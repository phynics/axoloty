...
- Full live wire suite (`make test-wire-live`) runs longer than ordinary checks and can exceed 20 minutes. Use an extended timeout of at least 30 minutes locally and in agent tooling; do not treat a shorter harness timeout as a test failure.
