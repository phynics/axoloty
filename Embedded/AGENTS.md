...
This guide applies to `Embedded/`. The root [`AGENTS.md`](../AGENTS.md) rules apply; this guide specializes them for firmware, Embedded Swift, ESP-IDF, and physical-device work.
