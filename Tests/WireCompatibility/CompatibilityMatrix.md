...
| Deadvertise | Compatible | Compatible with normalization | Compatible | Not tested | PR |
| Discover / Resolve | Compatible | Compatible with normalization | Compatible | Not tested | PR |
| Query / Retrieve | Compatible | Compatible with normalization (filters exercised) | Not tested | Not tested | PR |
| Update / Complete | Compatible | Compatible with normalization | Not tested | Not tested | PR |
| Call / Return | Compatible | Compatible with normalization | Not tested | Not tested | PR |
| Channel | Compatible | Compatible with normalization | Not tested | Not tested | PR |
