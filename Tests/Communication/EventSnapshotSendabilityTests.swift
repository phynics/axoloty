...
struct EventSnapshotSendabilityTests {
    ...
    @Test
    func associateEventSnapshotIsSendable() {
        let snapshot = AssociateEventSnapshot(
            sourceId: sampleSourceId(),
            ioContextName: "io-context",
            ioSourceId: "33333333-3333-4333-8333-333333333333",
            ioActorId: "44444444-4444-4444-8444-444444444444"
        )
        assertSendable(snapshot)
    }
}
