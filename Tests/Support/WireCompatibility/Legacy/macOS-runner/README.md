...
```sh
Tests/Support/WireCompatibility/Legacy/macOS-runner/prepare.sh
```
...
LEGACY_SCENARIO_COMMAND="$PWD/Tests/Support/WireCompatibility/Legacy/macOS-runner/run.sh" \
SCENARIO=advertise \
Tests/Support/WireCompatibility/Legacy/run_capture_on_macos.sh
...
`Tests/Support/WireCompatibility/Legacy/run-modern-to-legacy.sh` and require a macOS
