...
```sh
Tests/Support/WireCompatibility/Lifecycle/Live/run-lifecycle-call-return.sh duplicate-reply
Tests/Support/WireCompatibility/Lifecycle/Live/run-lifecycle-call-return.sh late-reply
Tests/Support/WireCompatibility/Lifecycle/Live/run-lifecycle-network.sh offline-queueing
Tests/Support/WireCompatibility/Lifecycle/Live/run-lifecycle-network.sh reconnect-resubscribe
Tests/Support/WireCompatibility/Lifecycle/Live/run-lifecycle-network.sh broker-restart
Tests/Support/WireCompatibility/Lifecycle/Live/run-lifecycle-network.sh clean-session
```
