...
CACHE_NAMESPACE="${CACHE_NAMESPACE:-swift-6.4-linux}"
...
for scenario in $SCENARIOS; do
    ...
    case "$scenario" in
        ...
        discover-resolve|query-retrieve)
            ...
            requester_mount="$ROOT_DIR/Tests/Support/WireCompatibility/Reverse/coatyjs-core-requester.js:/agent/coatyjs-core-requester.js:ro"
            ;;
        update-complete|call-return)
            requester_script="/agent/coatyjs-to-modern-requester.js"
            requester_mount="$ROOT_DIR/Tests/Support/WireCompatibility/Reverse/coatyjs-to-modern-requester.js:/agent/coatyjs-to-modern-requester.js:ro"
            ;;
    esac
