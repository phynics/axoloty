...
let exitCode = await runMCPServer(host: brokerHost, port: brokerPort, namespace: namespace)
Foundation.exit(exitCode)

@MainActor
func runMCPServer(host: String, port: UInt16, namespace: String) async -> Int32 {
    do {
