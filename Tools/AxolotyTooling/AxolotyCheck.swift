...
public struct AxolotyCheckPlan: Codable, Equatable, Sendable {
    ...
    public static func initialOffline(for platform: Platform) -> AxolotyCheckPlan {
        ...
        AxolotyCheckNode(name: "resolve-unchanged", dependencies: ["resolve"], command: AxolotyCommandPlan(executable: "git", arguments: ["diff", "--exit-code", "--", "Package.resolved"])),
        AxolotyCheckNode(name: "build", dependencies: ["resolve-unchanged"], command: AxolotyCommandPlan(executable: "swift", arguments: ["build", "--cache-path", ".swiftpm-cache", "--disable-automatic-resolution"])),
        AxolotyCheckNode(
            name: "lint",
            command: AxolotyCommandPlan(
