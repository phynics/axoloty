...
public class CommonOptions {
    ...
    public init(ioContextNodes: [String: IoNodeDefinition]? = nil, agentIdentity: [String: Any]? = nil, agentInfo: AgentInfo? = nil, extra: [String: Any]? = nil, logLevel: AxolotyLogLevel? = nil) {
...
public class CommunicationOptions {
    ...
    /// Options to connect with the MQTT client to broker.
