...
open class User: CoatyObject {
    ...
    open override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(ims, forKey: .ims)
        try container.encodeIfPresent(photos, forKey: .photos)
        try container.encodeIfPresent(addresses, forKey: .addresses)
        try container.encodeIfPresent(groups, forKey: .groups)
        try RawJSONValue.encodeRawStringIfPresent(entitlements, to: &container, forKey: .entitlements)
        try container.encodeIfPresent(roles, forKey: .roles)
        try container.encodeIfPresent(x509Certificates, forKey: .x509Certificates)
    }
