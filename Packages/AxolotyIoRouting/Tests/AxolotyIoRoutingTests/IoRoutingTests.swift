...
func basicRoutingMatchesScopedEndpoints() async throws {
    ...
    let sourceJSON: StaticString = "{\"objectId\":\"00000000-0000-4000-8000-000000000103\",\"objectType\":\"coaty.IoSource\",\"name\":\"source\",\"coreType\":\"IoSource\",\"parentObjectId\":\"00000000-0000-4000-8000-000000000102\",\"valueType\":\"com.example.Bool\",\"externalRoute\":\"plant/line7/temperature\"}"
    ...
    let source = try builder.ioSource(
        ...
        as: Bool.self,
        externalRoute: try MQTTExternalIoRoute("plant/line7/temperature")
    )
    ...
    let association = await transport.waitForPublication(containing: "plant/line7/temperature")
    #expect(association)
