...
AXOLOTY_CONSUMER_VERSION ?= 0.5.0
...
help:
	@printf '%s\n' \
		...
		'make serve-mqtt    Run the local MQTT broker in the foreground' \
		...
		'make embedded-network-test  Run the Swift MQTT overlay acceptance gate' \
